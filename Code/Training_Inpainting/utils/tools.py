...
# returns the mask as a [B, 1, 256, 256] tensor with values of 0 outside the mask and values of 1 inside the mask
# the effective mask's surface is at most 128x128, and at least 128-32,128-32
