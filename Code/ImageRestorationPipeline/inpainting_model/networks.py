...
from inpainting_utils.tools import extract_image_patches, flow_to_image, \
...
class Generator(nn.Module):
    def __init__(self, config, use_cuda):
        ...
        self.coarse_generator = CoarseGenerator(self.input_dim, self.cnum, config, self.use_cuda)
...
class CoarseGenerator(nn.Module):
    def __init__(self, input_dim, cnum, config, use_cuda=True):
